...
<html>
   ...
   <body>
      <header>
         <nav class="lightpink darken-2">
            <div class="nav-wrapper">
               <a href="#" data-activates="slide-out" class="button-collapse"><i class="fa fa-bars"></i></a>
               <a href="<?=site_url('home');?>" class="brand-logo"><img src="<?php echo base_url('assets/images/logo.png')?>" width="170px" alt=""></a>
      ...
      <main>
         ...
         <div class="cont">
            ...
            <!--light-pink-->
            <footer class="page-footer lightpink darken-3">
               <div class="container">
                  <div class="row">
